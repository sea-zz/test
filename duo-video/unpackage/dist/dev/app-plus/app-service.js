...
(function(vue) {
  ...
  const _sfc_main$1 = {
    ...
    onReady() {
      ...
      (_a = this.channelPanel) == null ? void 0 : _a.hide();
    },
    onLoad() {
      this.checkVip();
      this.setLandscape();
    ...
    methods: {
      ...
      checkVip() {
        ...
        if (!registerDate) {
          uni.setStorageSync(this.uuid, `${(/* @__PURE__ */ new Date()).toLocaleDateString()} ${(/* @__PURE__ */ new Date()).toLocaleTimeString()}`);
          this.vip = true;
        } else {
          const currentTime = Date.now();
          const registerExpireTime = new Date(registerDate).getTime() + 864e5 * 2;
            ...
            uni.request({
              ...
              success: (res) => {
                ...
                if ((_a = res == null ? void 0 : res.data) == null ? void 0 : _a.length) {
                  ...
                  if (user) {
                    const expireDateTime = (/* @__PURE__ */ new Date(`${user.expire_date} 23:59:59`)).getTime();
                    const currentTime2 = Date.now();
                    this.vip = expireDateTime > currentTime2 ? true : false;
                  }
                }
              }
            });
      ...
      // 视频点击处理
      toggleChannelPanel() {
        formatAppLog("log", "at pages/index/index.vue:206", "toggleChannelPanel被调用");
        if (!this.channelPanel) {
          formatAppLog("log", "at pages/index/index.vue:210", "重新获取SubNVue实例");
          this.channelPanel = uni.getSubNVueById("channelPanel");
        }
        if (this.channelPanel) {
          if (this.isPanelVisible) {
            ...
            try {
              ...
              formatAppLog("log", "at pages/index/index.vue:227", "SubNVue显示成功");
            } catch (error) {
              formatAppLog("error", "at pages/index/index.vue:229", "SubNVue显示失败:", error);
            }
          }
        } else {
          formatAppLog("error", "at pages/index/index.vue:233", "SubNVue实例未找到");
        }
      }
    }
  };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.loading ? (vue.openBlock(), vue.createElementBlock("view", {
      key: 0,
      style: { "background-color": "black", "width": "100vw", "height": "100vh" }
    })) : (vue.openBlock(), vue.createElementBlock("view", { key: 1 }, [
      !$data.vip ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "app-container-vip"
      }, [
        vue.createElementVNode("view", { class: "kefu-info" }, [
          ...
          vue.createElementVNode("view", { class: "info-uid" }, [
            vue.createTextVNode("尊敬的用户("),
            vue.createElementVNode(
              "text",
              { class: "uid" },
              "UID: " + vue.toDisplayString(this.uuid),
              1
              /* TEXT */
            ),
            vue.createTextVNode(")，体验已到期，如需继续使用，扫码联系支持！")
          ]),
          vue.createElementVNode("view", { class: "info-uid" }, [
            vue.createTextVNode("警告：系统重置、刷机、应用卸载均可致用户"),
            vue.createElementVNode("text", { class: "error" }, "UID"),
            vue.createTextVNode("变化，导致APP不可用，请谨慎操作！！！")
          ])
        ]),
        vue.createElementVNode("view", { class: "uid-info" }, [
          vue.createElementVNode("canvas", {
            "canvas-id": "qrcode",
            style: { "width": "200px", "height": "200px" }
          }),
          vue.createElementVNode("view", { class: "info-tips" }, "(扫码可快捷复制uid)")
        ])
        ...
        vue.createElementVNode("video", {
          id: "video-player",
          class: "video-player",
          src: $data.currentChannel.url,
          controls: false,
          fullscreen: true,
          autoplay: "",
          onError: _cache[0] || (_cache[0] = (...args) => $options.videoErrorCallback && $options.videoErrorCallback(...args))
        }, null, 40, ["src"]),
        vue.createCommentVNode(" 视频点击覆盖层 "),
        vue.createElementVNode(
          "cover-view",
          {
            class: "video-overlay",
            onClick: _cache[1] || (_cache[1] = (...args) => $options.toggleChannelPanel && $options.toggleChannelPanel(...args)),
            style: vue.normalizeStyle($data.overlayStyle)
          },
          null,
          4
          /* STYLE */
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-1cf27b2a"], ["__file", "/Users/haiyang.zhao/test/html/haiyan/duo-video/pages/index/index.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/Users/haiyang.zhao/test/html/haiyan/duo-video/App.vue"]]);
  function createApp() {
