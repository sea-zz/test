import { openBlock, createElementBlock, createElementVNode, createCommentVNode, normalizeStyle, Fragment, renderList, normalizeClass, toDisplayString } from "vue";
    ...
    createElementVNode("view", {
      ...
      createElementVNode("view", { class: "channel-panel-container" }, [
          ...
          [
            createElementVNode("scroll-view", {
              ...
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($data.cateChannel, (cate, index) => {
        ...
        createElementVNode(
          ...
          [
            $data.activeCategory === "个人信息" ? (openBlock(), createElementBlock(
              "view",
              {
                key: 0,
              ...
              [
                ...
                !$data.vip ? (openBlock(), createElementBlock("u-text", {
                  key: 0,
                  style: { "color": "#fff" },
                  class: "info-uid"
                }, "尊敬的用户，您的体验时间为两天，如想长久使用，扫码联系支持！")) : createCommentVNode("v-if", true),
              ...
              2
              /* CLASS */
            )) : (openBlock(), createElementBlock("scroll-view", {
              key: 1,
              ...
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($options.filteredChannels, (channel, index) => {
                  return openBlock(), createElementBlock("view", {
                    ...
                    createElementVNode("view", { class: "channel-name" }, [
                      createElementVNode(
                        ...
                        toDisplayString(channel.tvg_name || channel.tvg_id || channel.group_title),
                        1
                        /* TEXT */
                      )
                    ])
...
const channelPanel = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/haiyang.zhao/test/html/haiyan/duo-video/pages/index/channel-panel.nvue"]]);
export {
